...
import { BrdStateEntryService } from './brdstate-entry.service';

@Component({
  selector: 'app-brdstate-entry',
  templateUrl: './brdstate-entry.component.html',
  styleUrls: ['./brdstate-entry.component.scss']
})

export class BrdStateEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: BrdStateEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<BrdStateEntryComponent>,
