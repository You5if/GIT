...
import { WorkspaceEntryService } from './workspace-entry.service';

@Component({
  selector: 'app-workspace-entry',
  templateUrl: './workspace-entry.component.html',
  styleUrls: ['./workspace-entry.component.scss']
})
...
export class WorkspaceEntryComponent implements OnInit {
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<WorkspaceEntryComponent>,
