...
import { CardUserEntryService } from './carduser-entry.service';

@Component({
  selector: 'app-carduser-entry',
  templateUrl: './carduser-entry.component.html',
  styleUrls: ['./carduser-entry.component.scss']
})

export class CardUserEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: CardUserEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<CardUserEntryComponent>,
  ...
  ngOnInit() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.dapiService.Controllers(this.pModel.model).subscribe(res => {
        ...
        this.data[1].value = this.pModel.cardId.toString()
        this.data[2].refCondition = this.data[2].refCondition + this.pModel.cardId + "))"
