...
export class ProductCategoryComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle("Service category - GIS");
      this.refreshMe();
  }
  ...
  refreshMe() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.direction = "rtl"
      this.header = "فئات الخدمات"
      this.categoryCode = "رمز الفئة"
      this.categoryName = "اسم الفئة"
  ...
  onAdd = function () {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "اضافة فئة");
    }
  ...
  onEdit = (id: number) => {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "تعديل فئة");
    }
