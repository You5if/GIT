...
export class BoardService {
   ...
   getBoardSubmit(data: BoardModel) {
      ...
      switch (data.entryMode) {
          ...
          case 'A': {
          return this.http.post(this._globals.baseAPIUrl + 'BoardTemplate/create', data, this._cf.requestOptions()).pipe(
          ...
          case 'E': {
          return this.http.post(this._globals.baseAPIUrl + 'BoardTemplate/edit', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
          ...
          case 'D': {
          return this.http.post(this._globals.baseAPIUrl + 'BoardTemplate/delete', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
     ...
     getBoardsEntry(): Observable<BoardModel> {
      return this.httpClient.get<BoardModel>(this._globals.baseAPIUrl + 'BoardTemplate/byworkspace/1').pipe(
