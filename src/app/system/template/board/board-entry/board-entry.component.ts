...
import { BoardTEntryService } from './board-entry.service';

@Component({
  selector: 'app-board-entry',
  templateUrl: './board-entry.component.html',
  styleUrls: ['./board-entry.component.scss']
})

export class BoardTEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: BoardTEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<BoardTEntryComponent>,
  ...
  onSubmit() {
    ...
    //  this.last.records[9].value = localStorage.getItem(this._globals.baseAppName + '_workspaceId')
